    ...
    return (
        <>
            ...
            .swiper-slide.swiper-slide-active {
                --tw-border-opacity: transparent !important;
            }
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div
                        ...
                        <div className="w-full lg:w-2/5">
                            <span className="text-sm text-gray-200 font-medium mb-4 block">O que falam sobre nós?</span>
                            <h2 className="text-4xl font-bold text-gray-300 leading-[3.25rem] mb-8">< HTMLContent /> + Usuários aprovam e recomendam a <span
                                className=" text-transparent bg-clip-text bg-gradient-to-tr bg-linear-to-tr from-[#79A7DD] to-[#415A77]">Ekhytera</span>
                            </h2>

                            <div className="flex items-center justify-center lg:justify-start gap-10">
                                <button id="slider-button-left"
                                    className="swiper-button-prev group flex justify-center items-center border border-solid border-zinc-900 w-12 h-12 transition-all duration-500 rounded-lg hover:bg-indigo-600"
                                    data-carousel-prev>
                                ...
                                <button id="slider-button-right"
                                    className="swiper-button-next group flex justify-center items-center border border-solid border-zinc-900 w-12 h-12 transition-all duration-500 rounded-lg hover:bg-indigo-600"
                                    data-carousel-next>
                                    <svg className="h-6 w-6 text-indigo-600 group-hover:text-white" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                        ...
                        <div className="w-full lg:w-3/5">
                            <div className="swiper mySwiper">
                                <div className="swiper-wrapper">
                                    ...
                                    <div className="swiper-slide group bg-zinc-950 border border-solid border-zinc-800 rounded-2xl max-sm:max-w-sm max-sm:mx-auto p-6 transition-all duration-500 hover:border-zinc-900">
                                        <div className="flex items-center gap-5 mb-5 sm:mb-9">
                                            ...
                                            <div className="grid gap-1">
                                                <h5 className="text-gray-300 font-medium transition-all duration-500  ">Jane D</h5>
                                                <span className="text-sm leading-6 text-gray-200">CEO </span>
                                            </div>
                                        </div>
                                        <div
                                            className="flex items-center mb-5 sm:mb-9 gap-2 text-amber-500 transition-all duration-500  ">
                                        ...
                                        <p
                                            className="text-sm text-gray-200 leading-6 transition-all duration-500 min-h-24 ">
                                    ...
                                    <div
                                        className="swiper-slide group bg-zinc-950 border border-solid border-zinc-800 rounded-2xl max-sm:max-w-sm max-sm:mx-auto p-6 transition-all duration-500 hover:border-zinc-900">
                                        <div className="flex items-center gap-5 mb-5 sm:mb-9">
                                            <img className="rounded-full object-cover" src="	https://pagedone.io/asset/uploads/1696229994.png" alt="avatar" />
                                            <div className="grid gap-1">
                                                <h5 className="text-gray-300 font-medium transition-all duration-500  ">Harsh P.
                                                </h5>
