    ...
    <div className="bg-black py-24 sm:py-32">
      <div aria-hidden="true" className="blur-3xl absolute overflow-hidden flex items-start justify-center -mt-40 ml-90">
        <div
          ...
          className="relative  aspect-1155/678 w-144.5 -translate-x-1/2 rotate-30 bg-linear-to-tr from-[#79A7DD] to-[#415A77] opacity-30 sm:w-10 z-0 blur-3xl justify-center overflow-x-hidden md:w-144.5 lg:w-144.5"
        />
      </div>
      ...
      <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
        ...
        <div className="mt-10 grid gap-4 sm:mt-16 lg:grid-cols-3 lg:grid-rows-2">
          <div className="relative lg:row-span-2">
            <div className="absolute inset-px rounded-lg bg-zinc-950/50 blur-2x1 lg:rounded-l-4xl" />
          ...
          <div className="relative max-lg:row-start-1">
            <div className="absolute inset-px rounded-lg bg-zinc-950/50 blur-2x1 max-lg:rounded-t-4xl" />
          ...
          <div className="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
            <div className="absolute inset-px rounded-lg bg-zinc-950/50 blur-2x1" />
          ...
          <div className="relative lg:row-span-2">
            <div className="absolute inset-px rounded-lg bg-zinc-950/50 blur-2x1 max-lg:rounded-b-4xl lg:rounded-r-4xl" />
